...
d1 <- read.csv('../deleted-instances/FAILED-deletedSept2023.csv') %>% select(name, description, createdAt)
d2 <- read.csv('../deleted-instances/TERMINATED-deletedSept2023.csv') %>% select(name, description, createdAt)
d3 <- read.csv('../deleted-instances/deletedOct2023.csv') %>% select(name, description, createdAt)
d4 <- read.csv('../deleted-instances/TERMINATING_FAILED-deletedJan2025csv.csv') %>% select(name, description, createdAt)
d5 <- read.csv('../deleted-instances/STARTING_FAILED-deletedJan2025.csv') %>% select(name, description, createdAt)
d6 <- read.csv('../deleted-instances/STOPPING_FAILED-deletedJan2025.csv') %>% select(name, description, createdAt)
d7 <- read.csv('../deleted-instances/FAILED-deletedJan2025.csv') %>% select(name, description, createdAt) 
...
d4 <- read.csv('../deleted-instances/TERMINATING_FAILED-deletedJan2025csv.csv') %>%
  select(id, name, createdAt, createdBy, description, 
         envTypeConfigId, indexId,  projectId, status, studyIds, updatedAt, instanceType)
d5 <- read.csv('../deleted-instances/STARTING_FAILED-deletedJan2025.csv') %>%
  select(id, name, createdAt, createdBy, description, 
         envTypeConfigId, indexId,  projectId, status, studyIds, updatedAt, instanceType)
d6 <- read.csv('../deleted-instances/STOPPING_FAILED-deletedJan2025.csv') %>%
  select(id, name, createdAt, createdBy, description, 
         envTypeConfigId, indexId,  projectId, status, studyIds, updatedAt, instanceType)
d7 <- read.csv('../deleted-instances/FAILED-deletedJan2025.csv') %>%
  select(id, name, createdAt, createdBy, description, 
         envTypeConfigId, indexId,  projectId, status, studyIds, updatedAt, instanceType)
